package cz.jo.conner.repository;

import cz.jo.conner.ConnerApp;
import cz.jo.conner.config.Constants;
import cz.jo.conner.config.audit.AuditEventConverter;
import cz.jo.conner.domain.PersistentAuditEvent;
...
import static cz.jo.conner.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
